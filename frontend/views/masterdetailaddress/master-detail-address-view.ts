    ...
    return html`<vaadin-split-layout class="w-full h-full">
      ...
      <div class="flex flex-col" style="width: 400px;">
        <div class="p-l flex-grow">
          <vaadin-form-layout>
            <vaadin-text-field label="Street" id="street"></vaadin-text-field><vaadin-text-field label="Postal code" id="postalCode"></vaadin-text-field><vaadin-text-field label="City" id="city"></vaadin-text-field><vaadin-text-field label="State" id="state"></vaadin-text-field><vaadin-text-field label="Country" id="country"></vaadin-text-field>
          </vaadin-form-layout>
        </div>
