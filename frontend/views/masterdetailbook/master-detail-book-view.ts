        ...
        <div class="p-l flex-grow">
          <vaadin-form-layout>
            ...
            <vaadin-upload accept="image/*" max-files="1" style="box-sizing: border-box" id=image
              ><img id="imagePreview" class="w-full" />
            </vaadin-upload><vaadin-text-field label="Name" id="name"></vaadin-text-field><vaadin-text-field label="Author" id="author"></vaadin-text-field><vaadin-date-picker label="Publication date" id="publicationDate"></vaadin-date-picker><vaadin-text-field label="Pages" id="pages"></vaadin-text-field><vaadin-text-field label="Isbn" id="isbn"></vaadin-text-field>
          </vaadin-form-layout>
        </div>
