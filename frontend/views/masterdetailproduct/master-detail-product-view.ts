...
@customElement('master-detail-product-view')
export class MasterDetailProductView extends LitElement {
  createRenderRoot() {
      ...
      <div class="flex flex-col" style="width: 400px;">
        <div class="p-l flex-grow">
          <vaadin-form-layout>
            ...
            </vaadin-upload><vaadin-text-field label="Name" id="name"></vaadin-text-field><vaadin-text-field label="Ean code" id="eanCode"></vaadin-text-field>
          </vaadin-form-layout>
        </div>
