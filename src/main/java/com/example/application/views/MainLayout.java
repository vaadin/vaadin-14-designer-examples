 ...
 */
@PWA(name = "Vaadin 14 Designer Examples", shortName = "Vaadin 14 Designer Examples", enableInstallPrompt = false)
@Theme(themeFolder = "vaadin14designerexamples")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("Vaadin 14 Designer Examples");
